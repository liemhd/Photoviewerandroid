...
public class ShowCollection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvName = findViewById(R.id.tvNameAlbum);
        rvShowAlbum = findViewById(R.id.rvShowAlbum);
        ...
        Query query = dataHome.orderByChild("type".toLowerCase()).equalTo(nameAlbum.toLowerCase());

        int numberOfColumns = 2;
        rvShowAlbum.setLayoutManager(new GridLayoutManager(this, numberOfColumns));
        ...
        FirebaseRecyclerAdapter<Photo, PhotoViewHoler> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Photo, PhotoViewHoler>(options) {
            ...
            public PhotoViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_display_collection, parent, false);
...
//                        .apply(new RequestOptions().placeholder(R.mipmap.default_image))
                ...
                holder.rlDown.setOnClickListener(new View.OnClickListener() {
                    ...
                    private void DownImage(String nameImage) {
                        ...
                        if (direct.exists()) {
                            AlertDialog alertDialog = new AlertDialog.Builder(ShowCollection.this)
        ...
        rvShowAlbum.setAdapter(firebaseRecyclerAdapter);
    ...
    public static class PhotoViewHoler extends RecyclerView.ViewHolder {
        ...
        ImageView imvImage;
        RelativeLayout rlFavorite, rlDown;
